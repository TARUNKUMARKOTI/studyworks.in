        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-5">
              ...
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="text-academic-400 hover:text-academic-900 transition-colors transform hover:scale-110 duration-200">
              ...
              {/* WhatsApp */}
              <a href="#" aria-label="WhatsApp" className="text-academic-400 hover:text-academic-900 transition-colors transform hover:scale-110 duration-200">
              ...
              {/* LinkedIn */}
              <a href="#" aria-label="LinkedIn" className="text-academic-400 hover:text-academic-900 transition-colors transform hover:scale-110 duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
